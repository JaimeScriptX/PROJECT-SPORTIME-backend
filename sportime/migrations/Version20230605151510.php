 ...
 */
final class Version20230605151510 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE price (id INT AUTO_INCREMENT NOT NULL, fk_sport_id INT DEFAULT NULL, fk_sportcenter_id INT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, INDEX IDX_CAC822D99E50FF26 (fk_sport_id), INDEX IDX_CAC822D9345EA044 (fk_sportcenter_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
