 ...
 */
final class Version20230608091834 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sport_center_sport (sport_center_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', sport_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', INDEX IDX_3AA4F82672B00B1A (sport_center_id), INDEX IDX_3AA4F826AC78BCF8 (sport_id), PRIMARY KEY(sport_center_id, sport_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sport_center_services (sport_center_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', services_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', INDEX IDX_8815AE8D72B00B1A (sport_center_id), INDEX IDX_8815AE8DAEF5A6C1 (services_id), PRIMARY KEY(sport_center_id, services_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE event_players ADD fk_event_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD fk_person_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD team INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE events ADD fk_sport_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD fk_sportcenter_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD fk_difficulty_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD fk_sex_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD fk_person_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD fk_teamcolor_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD fk_teamcolor_two_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD fk_state_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE events_results ADD fk_event_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE person ADD fk_sex_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE reserved_time ADD fk_sport_center_id_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD fk_event_id_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE schedule_center ADD fk_sport_center_id_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
